...
class AuthController extends AppController
{
     ...
     */
    // need to go congif/app_local.app to change/add the email
    ...
    public function forgetPassword()
    {
        if ($this->request->is('post')) {
            ...
            if ($user) {
                // Set nonce and expiry date vendor/ugie-cake/cakephp-content-blocks/src/Model/Table/ContentBlocksTable.php
                $user->nonce = Security::randomString(128);
                $user->nonce_expiry = new FrozenTime('1 days');
    ...
    public function newPassword(?string $nonce = null)
    {
